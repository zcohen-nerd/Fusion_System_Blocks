"""Tests for fusion_addin/document.py using mock Fusion objects."""
...
import fusion_addin.document as doc_mod  # noqa: E402

doc_mod._FUSION_AVAILABLE = True

from fusion_addin.document import DocumentManager  # noqa: E402
