...
# Add core directory to path so we can import our modules
    ...
    def notify(self, args):
        try:
            ...
            if palette:
                ...
                parent_path = os.path.dirname(addin_path)  # Go up one level
                html_file = os.path.join(parent_path, 'frontend', 'html', 'palette.html')
    ...
    def notify(self, args):
        try:
            ...
            if htmlArgs.action == 'save_diagram':
                ...
                addin_path = os.path.dirname(__file__)
                parent_path = os.path.dirname(addin_path)  # Go up one level
                exports_path = os.path.join(parent_path, 'exports')
...
# For backward compatibility, provide the main functions that might be called externally
