...
def __getattr__(name):
    ...
    # Logging utilities - these don't depend on adsk at module level
        ...
        from fusion_addin.logging_util import setup_logging
        return setup_logging
    elif name == "log_exceptions":
        from fusion_addin.logging_util import log_exceptions
        return log_exceptions
    elif name == "log_environment_info":
        from fusion_addin.logging_util import log_environment_info
        return log_environment_info
    elif name == "get_log_file_path":
        from fusion_addin.logging_util import get_log_file_path
        return get_log_file_path
    elif name == "get_session_id":
        from fusion_addin.logging_util import get_session_id
        return get_session_id
    elif name == "cleanup_old_logs":
        from fusion_addin.logging_util import cleanup_old_logs
        return cleanup_old_logs
    elif name == "LoggedEventHandler":
        from fusion_addin.logging_util import LoggedEventHandler
        return LoggedEventHandler
    # Diagnostics - these depend on adsk at runtime but not at import
    elif name == "DiagnosticsRunner":
        from fusion_addin.diagnostics import DiagnosticsRunner
        return DiagnosticsRunner
    elif name == "DiagnosticResult":
        from fusion_addin.diagnostics import DiagnosticResult
        return DiagnosticResult
    elif name == "DiagnosticsReport":
        from fusion_addin.diagnostics import DiagnosticsReport
        return DiagnosticsReport
    elif name == "run_diagnostics_and_show_result":
        from fusion_addin.diagnostics import run_diagnostics_and_show_result
        return run_diagnostics_and_show_result
    elif name == "cleanup_any_remaining_temp_objects":
        from fusion_addin.diagnostics import cleanup_any_remaining_temp_objects
